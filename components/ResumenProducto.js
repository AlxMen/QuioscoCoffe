  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
      ...
      <div>
        <button
          type="button"
          className="bg-green-400 hover:bg-green-700 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full text-center mb-3"
        ...
        <button
          type="button"
          className="bg-red-500 hover:bg-red-700 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full text-center"
